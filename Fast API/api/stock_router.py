...
class LSTMModel(nn.Module):
    def __init__(self, input_size=5, hidden_size=64, num_layers=3, dropout=0.2): ## This was kept exactly same with Model training
...
# -----------------------------
#Load the model along with the training pipeline
# -----------------------------
